...
//       .map(item => {
//         const obj = item;
//         // Keep as string format for Traffic component compatibility
...
//           device_type: String(obj.device_type || 'unknown'),
...
//         return {
//           website_pageview_id: safeNumber(obj.website_pageview_id),
//           created_at: createdAt,
//           website_session_id: safeNumber(obj.website_session_id),
//           pageview_url: String(obj.pageview_url || '/'),
//         };
//       })
//       .filter((item) => item !== null);
//   };
...
//   const nullValues = ['nan', 'null', 'undefined', 'none', 'n/a', 'na', 'nan_ads'];
